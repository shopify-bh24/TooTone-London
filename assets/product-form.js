  ...
  customElements.define(
    ...
    class ProductForm extends HTMLElement {
      constructor() {
        ...
        this.variantIdInput = this.getVariantIdInput();

        if (!this.form) {
          console.warn("Form element not found inside <product-form>.");
          return;
        }
        ...
        if (this.variantIdInput) {
          ...
          console.warn("variantIdInput not found in the form.");
        }
        ...
        fetch(`${routes.cart_add_url}`, config)
          ...
          .then((response) => {
            if (response.status) {
              ...
              const soldOutMessage = this.submitButton ? this.submitButton.querySelector('.sold-out-message') : null;
